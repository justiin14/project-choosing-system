...
<html>
    ...
    <?php
            ...
            WHERE proiecte.id_proiect=proiecte_alese.id_proiect && proiecte_alese.id_user=useri.id_user && useri.id_grupa=grupe.id_grupa ORDER BY nume_user ");
